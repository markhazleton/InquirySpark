...
/// <summary>
/// Encodes the canonical URL route policy for InquirySpark.Web.
/// All user-facing capability surfaces are rooted under /Unified/ (greenfield-only, no legacy URL aliases).
/// See contracts/greenfield-route-policy.md for the authoritative policy document.
/// </summary>
public static class CanonicalRoutePolicy
{
    ...
    /// <summary>
    /// Returns true if the supplied path matches the canonical unified area prefix.
    /// </summary>
    ...
    /// <summary>
    /// Policy name constants matching authorization policy definitions in Program.cs.
    /// </summary>
